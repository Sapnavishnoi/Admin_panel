...
import {getSlot } from "../../services/roleService";
  ...
  React.useEffect(() => {
    async function fetchData() {
      try {
        ...
        const pageSize = 30;
        const _list = (result.detail.data).map((data) => {
          return {
            ...data
          };
        });
    ...
    <ContentShell
      ...
      actions={
        <>
          ...
          <ExportButton list={filteredlist} fileName="slot_report" />
        </>
      }
      loading={loading}
    >
      <Table
        ...
        columns={[
          ...
          { id: "totalSlot", label: "Total slot" },
          { id:  "month", label: "Month" },
          { id:  "leftslots", label: "Left Slot" },
